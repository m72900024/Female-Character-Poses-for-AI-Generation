...
export const positionDatabase = [
    { value: "(perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (正面)", label: "⬆️ 正面-面對鏡頭" },
