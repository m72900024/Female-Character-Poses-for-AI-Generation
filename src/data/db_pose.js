export const poseDatabase = [
    ...
    },
    {
        ...
        label: "蹲姿 (Squatting)",
        options: [
            { value: "Squatting down, knees together, cute pose, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (雙膝併攏蹲姿)", label: "雙膝併攏蹲姿 (Knees Together)" },
            { value: "Asian squat, heels flat on ground, relaxed casual, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (亞洲蹲)", label: "亞洲蹲 (Asian Squat)" },
            { value: "Squatting, one knee touching ground, kneeling squat, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (單膝跪蹲)", label: "單膝跪蹲 (One Knee Down)" },
            { value: "Squatting, looking up at camera, innocent eyes, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲姿仰視)", label: "蹲姿仰視 (Looking Up)" },
            { value: "Squatting, hugging knees to chest, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲姿抱膝)", label: "蹲姿抱膝 (Hugging Knees)" },
            { value: "Squatting, drawing on ground with finger, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲著畫畫)", label: "蹲著畫畫 (Drawing)" },
            { value: "Squatting, petting a cat gently, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲著摸貓)", label: "蹲著摸貓 (Petting Cat)" },
            { value: "Deep squat, legs wide apart, M-shape, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (M字深蹲)", label: "M字深蹲 (Deep Squat M)" },
            { value: "Squatting, balancing on toes, heels up, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (踮腳蹲姿)", label: "踮腳蹲姿 (On Toes)" },
            { value: "Squatting, holding phone taking photo, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲著拍照)", label: "蹲著拍照 (Taking Photo)" },
            { value: "Squatting, hands pulling skirt down modestly, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲姿拉裙)", label: "蹲姿拉裙 (Pulling Skirt)" },
            { value: "Squatting, one leg extended to side, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (伸腿蹲姿)", label: "伸腿蹲姿 (Leg Extended)" },
            { value: "Squatting, looking over shoulder, glancing back (回眸蹲姿)", label: "回眸蹲姿 (Looking Back)" },
            { value: "Squatting, chin resting on knees, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (下巴靠膝)", label: "下巴靠膝 (Chin on Knees)" },
            { value: "Squatting, hands holding ankles, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (手抓腳踝)", label: "手抓腳踝 (Holding Ankles)" },
            { value: "Squatting, leaning forward, elbows on knees, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲姿前傾)", label: "蹲姿前傾 (Leaning Forward)" },
            { value: "Squatting, hands on cheeks, looking up innocently, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲姿捧臉仰望)", label: "蹲姿捧臉仰望 (Cute Looking Up)" },
            { value: "Squatting, picking flowers, gentle smile, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (蹲姿採花)", label: "蹲姿採花 (Picking Flowers)" },
            { value: "Squatting, arms wrapped around knees, shy pose, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (害羞蹲姿)", label: "害羞蹲姿 (Shy Squat)" },
            { value: "Squatting low, head tilted, playful expression, (perfectly front view:2.5), (exactly facing camera:2.5), (dead center:2.0), (mirror symmetry:2.0), (bilateral symmetry:1.8), (zero rotation:1.5), looking at viewer (歪頭俏皮蹲)", label: "歪頭俏皮蹲 (Playful Tilt)" }
        ]
    },
    {
        id: "leg_focus",
