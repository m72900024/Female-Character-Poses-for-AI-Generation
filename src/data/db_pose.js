export const poseDatabase = [
    ...
    },
    {
        ...
        label: "蹲姿 (Squatting)",
        options: [
            { value: "Squatting down, body facing forward, knees together, cute pose (雙膝併攏蹲姿)", label: "雙膝併攏蹲姿 (Knees Together)" },
            { value: "Asian squat, body facing forward, heels on ground, relaxed (亞洲蹲)", label: "亞洲蹲 (Asian Squat)" },
            { value: "Squatting, body facing forward, one knee touching ground (單膝跪蹲)", label: "單膝跪蹲 (One Knee Down)" },
            { value: "Squatting, body facing forward, looking up at camera (蹲姿仰視)", label: "蹲姿仰視 (Looking Up)" },
            { value: "Squatting, body facing forward, hugging knees (蹲姿抱膝)", label: "蹲姿抱膝 (Hugging Knees)" },
            { value: "Squatting, body facing forward, drawing on ground (蹲著畫畫)", label: "蹲著畫畫 (Drawing)" },
            { value: "Squatting, body facing forward, petting a cat (蹲著摸貓)", label: "蹲著摸貓 (Petting Cat)" },
            { value: "Deep squat, body facing forward, legs wide apart (M字深蹲)", label: "M字深蹲 (Deep Squat M)" },
            { value: "Squatting, body facing forward, balancing on toes (踮腳蹲姿)", label: "踮腳蹲姿 (On Toes)" },
            { value: "Squatting, body facing forward, taking a photo (蹲著拍照)", label: "蹲著拍照 (Taking Photo)" },
            { value: "Squatting, body facing forward, pulling skirt tight (蹲姿拉裙)", label: "蹲姿拉裙 (Pulling Skirt)" },
            { value: "Squatting, body facing forward, one leg extended forward (前伸腿蹲姿)", label: "前伸腿蹲姿 (Leg Extended)" },
            { value: "Squatting, body facing forward, looking over shoulder (回眸蹲姿)", label: "回眸蹲姿 (Looking Back)" },
            { value: "Squatting, body facing forward, resting chin on knees (下巴靠膝)", label: "下巴靠膝 (Chin on Knees)" },
            { value: "Squatting, body facing forward, holding ankles (手抓腳踝)", label: "手抓腳踝 (Holding Ankles)" },
            { value: "Squatting, body facing forward, leaning forward (蹲姿前傾)", label: "蹲姿前傾 (Leaning Forward)" },
            { value: "Squatting, body facing forward, hands on cheeks, looking up innocently (蹲姿捧臉仰望)", label: "蹲姿捧臉仰望 (Cute Looking Up)" },
            { value: "Squatting, body facing forward, picking flowers, gentle smile (蹲姿採花)", label: "蹲姿採花 (Picking Flowers)" },
            { value: "Squatting, body facing forward, arms wrapped around knees, shy pose (害羞蹲姿)", label: "害羞蹲姿 (Shy Squat)" },
            { value: "Squatting low, body facing forward, head tilted, playful expression (歪頭俏皮蹲)", label: "歪頭俏皮蹲 (Playful Tilt)" }
        ]
    },
    {
        id: "leg_focus",
