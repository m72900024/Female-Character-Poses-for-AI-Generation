export const poseDatabase = [
    ...
    },
    {
        ...
        options: [
            ...
            { value: "Squatting, one leg extended forward, front view (前伸腿蹲姿)", label: "前伸腿蹲姿 (Leg Extended)" },
            { value: "Squatting, looking over shoulder, front body visible (回眸蹲姿)", label: "回眸蹲姿 (Looking Back)" },
