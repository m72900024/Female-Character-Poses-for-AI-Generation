export const poseDatabase = [
    ...
    },
    {
        ...
        options: [
            ...
            { value: "Squatting, hugging knees to chest (蹲姿抱膝)", label: "蹲姿抱膝 (Hugging Knees)" },
            { value: "Squatting, drawing on ground with finger (蹲著畫畫)", label: "蹲著畫畫 (Drawing)" },
            { value: "Squatting, petting a cat gently (蹲著摸貓)", label: "蹲著摸貓 (Petting Cat)" },
            { value: "Deep squat, legs wide apart, M-shape (M字深蹲)", label: "M字深蹲 (Deep Squat M)" },
            { value: "Squatting, balancing on toes, heels up (踮腳蹲姿)", label: "踮腳蹲姿 (On Toes)" },
            { value: "Squatting, holding phone taking photo (蹲著拍照)", label: "蹲著拍照 (Taking Photo)" },
            { value: "Squatting, hands pulling skirt down modestly (蹲姿拉裙)", label: "蹲姿拉裙 (Pulling Skirt)" },
            { value: "Squatting, one leg extended to side (伸腿蹲姿)", label: "伸腿蹲姿 (Leg Extended)" },
            { value: "Squatting, looking over shoulder, glancing back (回眸蹲姿)", label: "回眸蹲姿 (Looking Back)" },
            { value: "Squatting, chin resting on knees (下巴靠膝)", label: "下巴靠膝 (Chin on Knees)" },
            { value: "Squatting, hands holding ankles (手抓腳踝)", label: "手抓腳踝 (Holding Ankles)" },
            { value: "Squatting, leaning forward, elbows on knees (蹲姿前傾)", label: "蹲姿前傾 (Leaning Forward)" },
